...
names = {
        'Multi': 'Multi GT',
        'Linear': 'Linear GT',
        'Real_linear_denoise': 'Linear denoise',
        'Real_multi_signal_with_denoise': 'Side impute',
        'Real_multi_signal_with_RC': 'Side impute with RC',
        # added by Berkan not sure this is how it works
        'Real_multi_signal_with_RC_woStyle': 'Side impute with RC wo Style',
        'Real_multi_signal_with_RC_woStyleSyn': 'Side impute with RC wo Style Syn',
        'Real_multi_signal_with_RC_sides_two': 'Side impute with RC Two Sides',
        #####
        'Real_multi_signal_with_RC_scaled': 'Side impute with RC (scaled)',
        'Multi_denoise': 'Multi denoise',
        'Multi_RC': 'Multi without style',
        'unet_ellipsesSkinMask_20210412_lin2Ms_scaleclip_MAE': 'Unet'
    }

methods = ['BackProjection' , 'ElasticNet 1e-5']

selected_imgs = [1, 9, 12, 13, 22, 23, 26]

# files = [f'{path}/Multi.h5',
#          f'{path}/Linear.h5',
# #         f'{path}/plots/benchmark_invivo2021-09-13/Real_linear_denoise.h5',
# #         f'{path}/plots/benchmark_invivo2021-09-13/Real_multi_denoise.h5',
#          f'{path}//BenchmarkstyleLinear__2021-09-30/Reconstructions/Real_multi_signal_with_denoise/Real_multi_signal_with_denoise.h5',
# #         f'{path}//BenchmarkstyleLinear__2021-09-30/Reconstructions/Real_multi_signal_with_RC_scale0.00/Real_multi_signal_with_RC.h5',
# #          f'{path}//BenchmarkstyleLinear__2021-09-30/Reconstructions/Real_multi_signal_with_RC_scaled/Real_multi_signal_with_RC_scaled.h5',
#          f'{path}//BenchmarkstyleLinear__2021-09-30/Reconstructions/Real_multi_signal_with_RC/Real_multi_signal_with_RC.h5',
         
# #         f'{path}//BenchmarkstyleLinear__2021-09-30/Reconstructions/Real_multi_signal_with_RC_scale0.70/Real_multi_signal_with_RC_scaled.h5',         
# #          f'{path}//BenchmarkstyleFull35__2021-09-30/Reconstructions/Real_multi_signal_with_RC_scale0.00/Real_multi_signal_with_RC.h5',
# #          '/home/anna/OptoAcoustics/plots/benchmark_invivo2021-09-15_scaled/Multi_RC.h5',
# #         '/home/anna/OptoAcoustics/plots/benchmark_invivo_multi2021-09-14/Multi_denoise.h5',
#          f'{path}/from_firat//unet_ellipsesSkinMask_20210412_lin2Ms_scaleclip_MAE.h5',
        
#         # benchmarks
#         f'{path}//Behnch_woStyle_L2_full_styleNone_2022-02-07/Reconstructions/Real_multi_signal_with_RC/Real_multi_signal_with_RC_woStyle.h5',
#         f'{path}//Behnch_woStyleSyn_L2_full_styleNone_2022-02-08/Reconstructions/Real_multi_signal_with_RC/Real_multi_signal_with_RC_woStyleSyn.h5',
#         f'{path}//LinearInput_sidesTwo__2021-09-20/Reconstructions/Real_multi_signal_with_RC/Real_multi_signal_with_RC_sides_two.h5'
#         ]

iles = ['Multi': f'/home/anna/dlbirhoui_data//Reconstructions/arm_multi_sigmat_multisegment//arm_multi_sigmat_multisegment.h5',
        ...
        # benchmarks
        'Side impute with RC wo Style': f'{path}//Behnch_woStyle_L2_full_styleNone_2022-02-07/Reconstructions/Real_multi_signal_with_RC/Real_multi_signal_with_RC_woStyle.h5',
        'Side impute with RC wo Style Syn': f'{path}//Behnch_woStyleSyn_L2_full_styleNone_2022-02-08/Reconstructions/Real_multi_signal_with_RC/Real_multi_signal_with_RC_woStyleSyn.h5',
        'Side impute with RC Two Sides': f'{path}//LinearInput_sidesTwo__2021-09-20/Reconstructions/Real_multi_signal_with_RC/Real_multi_signal_with_RC_sides_two.h5'
        ]
...
def show(
    ...
    for i in range(n1):
        for j in range(n2):
            if l < len(titels):
                ax[i, j].imshow(reconstrutctions[titels[l]][im], cmap=cmap)
                imgs_dict[mode] = reconstrutctions[titels[l]][im]
                # , cmap='seismic'
...
def figure_plot(
    ...
    n2 = len(modalities)
    methods = list(imgs_dict['Multi'].keys())
    n1 = len(methods)
...
#             metrics_dict[method][modality] = {}            
            ...
            pred = scale(pred)
            imgs_correct[method][names[modality]] = pred
...
#             s = spearmanr(gt.reshape(-1), pred.reshape(-1))[0]
            ...
            metrics_dict[method]['SSIM'][names[modality]] = ssim_const
            metrics_dict[method]['MSE'][names[modality]] = mse
            metrics_dict[method]['MAE'][names[modality]] = mae
            metrics_dict[method]['SNR'][names[modality]] = s
            metrics_dict[method]['pearson'][names[modality]] = p
            metrics_dict[method]['R2'][names[modality]] = r2
            metrics_dict[method]['PSNR'][names[modality]] = psnr
...
#             ax[i, j].set_title(f"{modality}", fontsize=9, fontweight='bold')
            ...
            if i == 0:
                ax[i, j].set_title(
                    f'{names[modality]}'+ f'\n{tgt_metric}={metrics_dict[method][tgt_metric][names[modality]]:.2f}', fontsize=9)
            else:
                ax[i, j].set_title(
                    f'{tgt_metric}={metrics_dict[method][tgt_metric][names[modality]]:.2f}', fontsize=9)
...
if __name__ == "__main__":
    ...
    for i_im in range(32):
        imgs_dict = {}
        for fname in files:
            f = files[fname]
            print(fname)
            file = h5py.File(f, 'r')
            imgs_dict[fname] = show(file, im=i_im, methods=methods)

        # imgs_correct, metrics_dict = figure_plot(
        #     imgs_dict,
        #     tgt_metric='SSIM',
        #     fname=f'./PaperFigures/1024_all/Img_{i_im}_withunet.png'
        # )
